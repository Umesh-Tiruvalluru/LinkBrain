  ...
  return (
    <div className="bg-gray-50 min-h-dvh flex flex-col">
      <div className="relative flex flex-col items-center justify-center gap-4 w-full h-80 bg-gradient-to-r from-indigo-700 via-purple-600 to-indigo-900 text-center">
        ...
        <button
          onClick={() => navigate("/")}
          className="mt-4 px-6 py-2 bg-white z-50 text-indigo-700 cursor-pointer font-semibold rounded-lg shadow hover:bg-gray-200 transition duration-300"
        >
      ...
      <MaxWidthWrapper>
        <div className="mt-8">
          {data.content ? (
            <CardContainer data={data.content} isPending={false} />
          ) : (
